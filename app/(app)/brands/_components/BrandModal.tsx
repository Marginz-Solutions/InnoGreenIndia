  ...
  useEffect(() => {
    ...
    if(editBrand) {
      setForm({
        ...
        contact: {
          name: editBrand.contacts?.name ?? '',
          email: editBrand.contacts?.email ?? '',
          phoneNo: editBrand.contacts?.phoneNo ?? '',
          whatsapp: editBrand.contacts?.whatsapp ?? '',
          addressLine1: editBrand.contacts?.addressLine1 ?? '',
          addressLine2: editBrand.contacts?.addressLine2 ?? '',
          city: editBrand.contacts?.city ?? '',
          state: editBrand.contacts?.state ?? '',
          pincode: editBrand.contacts?.pincode ?? '',
        },
